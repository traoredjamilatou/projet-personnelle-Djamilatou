...
<li class="nav-item">
  ...
  <!-- <section class="innerpage bg-yellow">
    ...
    <div class="A">
    <i class="bi bi-star-fill nom"></i>
    <h1 class="Libre-bold text-white mb-0">A PROPOS DE NOUS</h1>
    <i class="bi bi-star-fill no"></i>
    </div>
    </div>
    </div>
    </section> -->
  ...
  <section class="F">
    ...
    <div>
      <p>Nous aidons les detenus à gagner leur indépendance en facilitant les processus de mise en marche, de gestion et
        ...
        tous.</p>
      <!-- <p>Créé en mai 2023, .... est devenu le site e-commerce au Burkina Faso. Je proposon à mais clients un large assortiment de produits, des prix compétitifs et des <br> délais de livraison toujours plus réduits, dans le but d'offrir une expérience client de qualité.</p> -->
      <!-- <p>Aujourd'hui, notre réseau nous permet de livrer dans plus de 100 villes de Côte d'Ivoire pour servir le plus grand nombre de consommateurs.</p> -->
    </div>
  </section>
  <section class="J">
    <div class="I">
    ...
    <div>
      <p>...., qui se composait au départ une(1) personnes qui se retrouvaient dans un centre informatique pour
        travailler, va emploiyer bientot plus de 10 000 personnes au Burkina Faso. Des millions d’entreprises feront
        confiance à ...., je devons donc avoir le souci de nos collaborateurs et de nos communautés. Notre initiatives à
        impact social met l’accent sur les moyens de garantir un futur équitable en concevant des produits et programmes
        pour aider nos équipes et nos marchands.</p>
      <!-- <p>▸... au Burkina Faso est la première entreprise Africaine lauréat des prix de vente au détail en 2013 succédant aux entreprises comme ASOS et Zappos.com.</p>
        <p>▸ Leadership des TIC de l'année 2013 - Jumia</p>
        <p>▸ Meilleur site de vente en ligne de l'année (Beacon of ICT Award)</p>
        <p>▸ Success Digest - Activité innovante de l'année 2013.</p>
        <p>▸ Prix ​​d'excellence du meilleur service à la clientèle 2015</p>
        <p>▸ Orange Academy brand wall of Fame - Jumia Côte d'Ivoire.</p>
        <p>▸ Rima Awards - Meilleure utilisation de l'application mobile - Jumia App.</p> -->
    </div>
    <hr>
  </section>
  <div class="main-btn">
    <a href="#" class="btn btn2">ACHETEZ MAINTENANT</a>
    <!-- <a href="#" class="btn btn2">VENTE SUR ....</a>
        <a href="#" class="btn btn2">AFFILIATION</a>
        <a href="#" class="btn btn2">J-FORCE</a> -->
